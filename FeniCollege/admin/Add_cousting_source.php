...
if(isset($_POST['add']))
	{
		...
		{
			$query="INSERT INTO `add_cousting_source` (`id`,`title`,`details`,`Duration_to`,`duration_from`,`amount`) VALUES ('".$fetch[0]."','$title','$detisls','$durationto','$durationfrom','$amount')";
...
if(isset($_POST['Delete']))
	{
		$id=$db->escape($_POST['id']);
		$query="DELETE FROM `add_cousting_source` WHERE `id`='$id'";
...
if(isset($_POST['Update']))
	{
		...
		if(!empty($id) && !empty($title) && !empty($amount))
		{
			$query="REPLACE INTO `add_cousting_source` (`id`,`title`,`details`,`Duration_to`,`duration_from`,`amount`) VALUES ('$id','$title','$detisls','$durationto','$durationfrom','$amount')";
...
function check_availability()
{
  ...
  <body>
  	...
  	<table align="center" class="table table-responsive box" style="border:1px #CCCCCC solid; margin-top:30px; color: #000;">
  			<tr>
  				<td bgcolor="#f4f4f4" class="warning" colspan="4" bgcolor="#dddddd" align="center"><span style="font-size:22px; color:#333; display:block;">Add Cousting Source </span> </td>
  			</tr>
			...
			<tr>
				...
				<td class="info">
					<div class="col-lg-12 has-warning">
						<input type="text" placeholder="Amount" class="form-control" name="amount" value="<?php echo $fetch[5];?>" />
						<span class="glyphicon glyphicon-warning-sign form-control-feedback"></span>
					</div>
				</td>
				<td class='info'><span class="text-danger text-justify"><strong></strong></span ></td>
			...
			<tr>
				...
				<td class="info" colspan="2">
					<div class="col-lg-5 col-md-5 has-info">
						<input type="text" value="<?php echo $fetch[3];?>" id="example1"  class="form-control" placeholder="Duration" name="duration1"  />
						
					</div>
						<div class="col-md-1 col-lg-1"><strong class="text-danger">To</strong></div>
					<div class="col-lg-5 col-md-5 has-info">
						<input type="text" id="example2"  class="form-control" placeholder="Duration" name="duration2" value="<?php echo $fetch[4];?>" />
