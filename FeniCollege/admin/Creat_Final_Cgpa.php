...
function Check_exam_type()
{
	...
	function totalStudent(){
		...
		$.ajax({
				url:"CGpaGenerate.php",
				type:"POST",
				data:{ClassId:ClassId,ExamId:ExamId,Session:Session,stotalstd:stotalstd},
				cache:false,
  ...
  <body>
  	<form name="teacherinfo" action="" method="post"  enctype="multipart/form-data" class="form-horizontal marksEditEntry" >
            <div class="col-md-8 col-md-offset-2" id="AddMarksStep1"><br/> <br/>
                <span class="glyphicon glyphicon-arrow-right text-justify text-uppercase text-warning" style="font-weight: bold; padding-top: 15px; font-size: 18px;"><strong style="padding-left:5px">Generate CGPA </strong></span><br/>
...
<input type="text" name="to" id="to"  style="width:120px; background:#F7071D; border:none; font-weight:bold; color:#fff; height:25px;  text-align:center;"/>
                ...
                <tr><td colspan="2" align="center"><input type="button" name="ResultGenerate" value="Result Generate" class="btn btn-danger btn-md" style="width: 180px" onClick="return resultGen()" ></input>
				<input type="button" name="submit" value="Update Result" class="btn btn-danger btn-md"  style="width: 180px" onClick="return resultGen()"></input>
