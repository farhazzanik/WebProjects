	 ...
	 <script>
	   $(document).ready(function () {
				...
				function showATtendance(){
						...
						$('#secondDive').show();
					$.ajax({
							url : "ajaxForDateWiseTeacherAttendance.php",
	 ...
	 <div class="col-lg-12" id="frstDiv">
	 	...
	 	<table width="" border="0" class="table-responsive table-bordered" style="margin-top:10px; width:100%;">
					  ...
					  <tr>
					    ...
					    <td height="30" colspan="9" align="center">&nbsp;<span><strong class="text-capitalize text-success" style="font-size:14px" > List of Teachers Attendance</strong></span></td>
