...
if(isset($_POST['add']))
	{
		...
		{
			$query_ass="INSERT INTO `other_cost` (`id`,`date`,`title`,`description`,`amount`,`admin_id`) VALUES ('$id','$date','$title','$description','$amount','$adminame')";
...
if(isset($_POST['Delete']))
	{
		...
		$fetch[0]=$db->autogenerat('other_cost','id','OTC-','9');
		print "<script>location='Othercost.php'</script";
...
if(isset($_POST['Update']))
	{
		...
		if(!empty($id) && !empty($date) && !empty($title) && !empty($amount) && !empty($adminame))
		{
			$query_ass="REPLACE INTO `other_cost` (`id`,`date`,`title`,`description`,`amount`,`admin_id`) VALUES ('$id','$date','$title','$description','$amount','$adminame')";
...
<html lang="en">
  ...
  <body>
  	...
  	<table align="center" class="table table-responsive box" style="border:1px #CCCCCC solid; margin-top:30px; color: #000;">
  			<tr>
  				<td bgcolor="#f4f4f4" class="warning" colspan="4" bgcolor="#dddddd" align="center"><span style="font-size:22px; color:#333; display:block;">Other Cost </span> </td>
  			</tr>
