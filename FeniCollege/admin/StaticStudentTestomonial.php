 ...
 <script>
		...
		function ResultAdd(){
				...
				$.ajax({
							url:"ajaxForBoardResult.php",
							type:"POST",
							data : {sataticchekId:sataticchekId,title:title,group:group,type:type,studentID:studentID,RollNO:RollNO,regNo:regNo,gpa:gpa,session:session,Year:Year,studentName:studentName,MotherName:MotherName,fatherName:fatherName,gender:gender,example2:example2},
							 success : function(text)
								{
									//alert(text);
									$("#msgShow").html(text);
