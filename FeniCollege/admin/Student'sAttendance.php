			...
			$('#smsshow').html('');
					$.ajax({
						...
						success:function(data){
							...
							$('#smsshow').html("<span class='text-center text-danger '><strong>&nbsp;limit are too long (at least 30)...</strong></span>");
							return false;
...
<input type="text" name="to" id="to"  onkeyup="return showStudent()"  onChange="return showStudent()" style="width:120px; background:#F7071D; border:none; font-weight:bold; color:#fff; height:25px;  text-align:center;"/>&nbsp;&nbsp;&nbsp;&nbsp;<span id="smsshow"></span><br/>
								</td>
						</tr>
