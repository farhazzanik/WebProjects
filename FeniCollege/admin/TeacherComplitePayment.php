...
function ADDandDelete(){
	...
	if(paidAmount != '' && teacherId !='' && duammmount !='' ){
	 $.ajax({
                    ...
                    type: "POST",
                    url: "ajaxforCompletepaymet.php",
                    data:{AddandDelete:AddandDelete,totalpayable:totalpayable,paidAmount:paidAmount,duammmount:duammmount,teacherName:teacherName,teacherId:teacherId},
                    cache: false,
                    success: function(data) {
...
function ShowHistoryTeacher(){
	...
	if(teacherId !=''){
		$.ajax({
                    ...
                    type: "POST",
                    url: "ajaxforCompletepaymet.php",
                    data:{showDAta:showDAta,teacherId:teacherId},
                    cache: false,
                    success: function(data) {
