...
<html lang="en">
  ...
  <tr style="border:1px #000000 solid;">
    <td height="24" colspan="2" align="center" style="border:1px #000000 solid;"><strong><span class="text-justify text-success" style="">Tabulation Sheet (<?php if(isset($fetchSelectName)){echo $fetchSelectName["exam_type"];} else {echo "";}?>)</span></strong></td>
  </tr>
  <tr >
...
<!--	fdsg-->
      ...
      <table width="389" height="173" border="1" class="" cellpadding="0" cellspacing="0" align="center">
...
AND `result`.`GroupID`='$gpId' AND `result`.`session`='$session' ORDER BY `result`.`std_roll` ASC";
		...
		<tr bgcolor="#f1f1f1"  >
          ...
          <td width="17" height="27" align="center" style="border:1px #000000 solid;"><strong style="color:#000000; font-size:16px">ID</strong></td>
          <td width="30" align="center" style="border:1px #000000 solid;"><strong style="color:#000000 ; font-size:16px">Roll</strong></td>
          <td width="45" align="center" style="border:1px #000000 solid;"><strong style="color:#000000 ; font-size:16px">Name</strong></td>
		  <?php  
...
AND `add_subject_info`.`select_subject_type`='CompulsorySubject' AND `marksheet`.`ExamId`='$examId' AND `marksheet`.`Session`='$session' AND `marksheet`.`ClassId`='$clId' AND `marksheet`.`GroupID`='$gpId' ORDER BY `add_subject_info`.`serial` ASC";
          ...
          <td height="27" colspan="5" align="center" style="border:1px #000000 solid;"><strong style="color:#000000 ; font-size:16px"><?php //echo $fetchsubtype["select_subject_type"];?><?php if($fetchsubtype["SubjectPartID"]!="NULL") {
		   	 $sqlForPart=" SELECT `add_subject_part_info`.`subject_part_code`,`subject_part_name` FROM `add_subject_part_info` WHERE `part_id`='$fetchsubtype[SubjectPartID]' AND `subject_name`='$fetchsubtype[SubjectId]'   AND `exam_type`='$examId'";
...
AND `add_subject_info`.`select_subject_type`='OptionalSubject' AND `marksheet`.`ExamId`='$examId' AND `marksheet`.`Session`='$session' AND `marksheet`.`ClassId`='$clId' AND `marksheet`.`GroupID`='$gpId' ORDER BY `add_subject_info`.`serial` ASC";
        ...
        <tr >
          <td width="17" rowspan="5" align="center" style="border:1px #000000 solid;"><strong style="color:#000000; font-size:16px"><?php echo $fetchFroStudent["STD_ID"];?></strong></td>
          <td width="30" rowspan="5" align="center" style="border:1px #000000 solid;"><strong style="color:#000000; font-size:16px"><?php echo $fetchFroStudent["std_roll"];?></strong></td>
          <td width="45" rowspan="5" align="center" style="border:1px #000000 solid;"><strong style="color:#000000; font-size:16px"><?php echo $fetchFroStudent["student_name"];?></strong> </td>
		<?php 
...
AND `add_subject_info`.`select_subject_type`='CompulsorySubject' AND `marksheet`.`ExamId`='$examId' AND `marksheet`.`Session`='$session' AND `marksheet`.`ClassId`='$clId' AND `marksheet`.`GroupID`='$gpId' ORDER BY `add_subject_info`.`serial` ASC";
		...
		?>
				...
				<td width="23" height="30" align="center" style="border:1px #000000 solid;"> <strong style="color:#000000; font-size:16px">CA</strong></td>
			  <td width="22" align="center" style="border:1px #000000 solid;"><strong style="color:#000000; font-size:16px">CT</strong></td>
			  <td width="26" align="center" style="border:1px #000000 solid;"><strong style="color:#000000; font-size:16px">MC</strong></td>
			  <td width="24" height="30" align="center" style="border:1px #000000 solid;"><strong style="color:#000000; font-size:16px">PT</strong></td>
			  <td width="55" align="center" style="border:1px #000000 solid;"><strong style="color:#000000; font-size:16px">Full Marks</strong> </td>
...
AND `add_subject_info`.`select_subject_type`='OptionalSubject' AND `marksheet`.`ExamId`='$examId' AND `marksheet`.`Session`='$session' AND `marksheet`.`ClassId`='$clId' AND `marksheet`.`GroupID`='$gpId' ORDER BY `add_subject_info`.`serial` ASC";
		...
		?>
			...
			<?php } }  ?>
			<td width="30" rowspan="5" align="center" style="border:1px #000000 solid;"><strong style="color:#000000; font-size:16px"><?php echo $fetchFroStudent["CGPA"];?></strong> </td>
        </tr>
        <tr >
		<?php 
 ...
 AND `add_subject_info`.`select_subject_type`='CompulsorySubject' AND `marksheet`.`ExamId`='$examId' ORDER BY  `add_subject_info`.`serial` ASC";
		...
		?>
          ...
          <td width="23" height="24" align="center" style="border:1px #000000 solid;"><strong style="color:#000000">
		  <?php 
		  		if($fetsubInfo["SubjectPartID"] != "NULL")
				{
					$sqlSubjectMarks="SELECT `subject_information`.`ContAss`,`Creative`,`MCQ`,`practical`,`total` FROM `subject_information` WHERE `subjectId`='$fetsubInfo[SubjectId]' AND `subPartId`='$fetsubInfo[SubjectPartID]' AND examID='$examId'";
				}else {
				
					$sqlSubjectMarks="SELECT `subject_information`.`ContAss`,`Creative`,`MCQ`,`practical`,`total` FROM `subject_information` WHERE `subjectId`='$fetsubInfo[SubjectId]' AND examID='$examId'";
				}
				...
				echo $fetchOldsubjecino["ContAss"];
		  ?>
		 </strong> </td>
          <td width="22" align="center" style="border:1px #000000 solid;"><strong style="color:#000000; font-size:16px"><?php echo $fetchOldsubjecino["Creative"];?></strong></td>
          <td width="26" align="center" style="border:1px #000000 solid;"><strong style="color:#000000; font-size:16px"><?php echo $fetchOldsubjecino["MCQ"];?></strong></td>
          <td width="24" height="24" align="center" style="border:1px #000000 solid;"><strong style="color:#000000; font-size:16px"><?php echo $fetchOldsubjecino["practical"];?></strong></td>
          <td width="55" align="center" style="border:1px #000000 solid;"><strong style="color:#000000; font-size:16px"><?php echo $fetchOldsubjecino["total"];?></strong></td>
		  <?php } ?>
       	<?php } ?>
 ...
 AND `add_subject_info`.`select_subject_type`='OptionalSubject' AND `marksheet`.`ExamId`='$examId' ORDER BY  `add_subject_info`.`serial` ASC";
        ...
        <tr >
		<?php 
			 $forstudenObtaimnMarks=" SELECT `marksheet`.*,`add_subject_info`.`select_subject_type` FROM `marksheet` 
 INNER JOIN `add_subject_info` ON `marksheet`.`SubjectId`=`add_subject_info`.`id` WHERE `STudentID`='$fetchFroStudent[STD_ID]' 
 AND `add_subject_info`.`select_subject_type`='CompulsorySubject' AND `marksheet`.`ExamId`='$examId' ORDER BY  `add_subject_info`.`serial` ASC";
		//print $forSubjectInfo;
			$resultforstudenObtaimnMarks=$db->select_query($forstudenObtaimnMarks);
			if($resultforstudenObtaimnMarks){
				while($fetchresultforstudenObtaimnMarks=$resultforstudenObtaimnMarks->fetch_array()){
		
		?>
          <td width="23" rowspan="3" align="center" style="border:1px #000000 solid;"><strong style="color:#000000; font-size:16px"><?php echo $fetchresultforstudenObtaimnMarks["Count_Ass"];?></strong></td>
          <td width="22" rowspan="3" align="center" style="border:1px #000000 solid;"><strong style="color:#000000; font-size:16px"><?php echo $fetchresultforstudenObtaimnMarks["Creative"];?></strong></td>
          <td width="26" rowspan="3" align="center" style="border:1px #000000 solid;"><strong style="color:#000000; font-size:16px"><?php echo $fetchresultforstudenObtaimnMarks["Mcq"];?></strong></td>
          <td width="24" rowspan="3" align="center" style="border:1px #000000 solid;"><strong style="color:#000000; font-size:16px"><?php echo $fetchresultforstudenObtaimnMarks["Practical"];?></strong></td>
          <td height="25" align="center" style="border:1px #000000 solid;"><strong style="color:#000000 ; font-size:16px"><?php echo $fetchresultforstudenObtaimnMarks["obtainMark"];?></strong></td>
        <?php } }?>
		
		<?php 
			 $forstudenObtaimnMarksgp=" SELECT `marksheet`.*,`add_subject_info`.`select_subject_type` FROM `marksheet` 
 INNER JOIN `add_subject_info` ON `marksheet`.`SubjectId`=`add_subject_info`.`id` WHERE `STudentID`='$fetchFroStudent[STD_ID]' 
 AND `add_subject_info`.`select_subject_type`='GroupSubject' AND `marksheet`.`ExamId`='$examId' ORDER BY  `add_subject_info`.`serial` ASC";
		//print $forSubjectInfo;
			$resultforstudenObtaimnMarksgp=$db->select_query($forstudenObtaimnMarksgp);
			if(resultforstudenObtaimnMarksgp){
				while($fetchresultforstudenObtaimnMarks=$resultforstudenObtaimnMarksgp->fetch_array()){
		...
		<?php 
			 $forstudenObtaimnMarksop=" SELECT `marksheet`.*,`add_subject_info`.`select_subject_type` FROM `marksheet` 
 INNER JOIN `add_subject_info` ON `marksheet`.`SubjectId`=`add_subject_info`.`id` WHERE `STudentID`='$fetchFroStudent[STD_ID]' 
 AND `add_subject_info`.`select_subject_type`='OptionalSubject' AND `marksheet`.`ExamId`='$examId' ORDER BY  `add_subject_info`.`serial` ASC";
		//print $forSubjectInfo;
			$resultforstudenObtaimnMarksop=$db->select_query($forstudenObtaimnMarksop);
			if($resultforstudenObtaimnMarksop){
				while($fetchresultforstudenObtaimnMarks=$resultforstudenObtaimnMarksop->fetch_array()){
        ...
        <tr>
		<?php 
			$forLetterGrade="  SELECT `marksheet`.*,`add_subject_info`.`select_subject_type` FROM `marksheet` 
 INNER JOIN `add_subject_info` ON `marksheet`.`SubjectId`=`add_subject_info`.`id` WHERE `STudentID`='$fetchFroStudent[STD_ID]' 
 AND `add_subject_info`.`select_subject_type`='CompulsorySubject' AND `marksheet`.`ExamId`='$examId' ORDER BY  `add_subject_info`.`serial` ASC";
		//print $forSubjectInfo;
			$resultforLetterGrade=$db->select_query($forLetterGrade);
			if($resultforLetterGrade){
				while($fetresultforLetterGrade=$resultforLetterGrade->fetch_array()){
		
		?>
		<?php 
			
			if($fetresultforLetterGrade["LetterGrade"]=="F"){
		?>
          <td height="25" align="center" bgcolor="#FF0000" style="border:1px #000000 solid;"><strong style="color:#fffff; font-size:16pxf"><?php echo $fetresultforLetterGrade["LetterGrade"];?></strong></td>
        <?php } else {?>
			<td width="46" height="25" align="center" style="border:1px #000000 solid;" bgcolor="#02751C"><strong style="color:#000000; font-size:16px"><?php echo $fetresultforLetterGrade["LetterGrade"];?></strong></td>
		<?php } } }?>
		
				<?php 
			$forLetterGradegp="  SELECT `marksheet`.*,`add_subject_info`.`select_subject_type` FROM `marksheet` 
 INNER JOIN `add_subject_info` ON `marksheet`.`SubjectId`=`add_subject_info`.`id` WHERE `STudentID`='$fetchFroStudent[STD_ID]' 
 AND `add_subject_info`.`select_subject_type`='GroupSubject' AND `marksheet`.`ExamId`='$examId' ORDER BY  `add_subject_info`.`serial` ASC";
		//print $forSubjectInfo;
			$resultforLetterGradefgp=$db->select_query($forLetterGradegp);
			if($resultforLetterGradefgp){
				while($fetresultforLetterGrade=$resultforLetterGradefgp->fetch_array()){
		...
		<?php } } }?>
			...
			<?php 
			$forLetterGradeop="  SELECT `marksheet`.*,`add_subject_info`.`select_subject_type` FROM `marksheet` 
 INNER JOIN `add_subject_info` ON `marksheet`.`SubjectId`=`add_subject_info`.`id` WHERE `STudentID`='$fetchFroStudent[STD_ID]' 
 AND `add_subject_info`.`select_subject_type`='OptionalSubject' AND `marksheet`.`ExamId`='$examId' ORDER BY  `add_subject_info`.`serial` ASC";
		//print $forSubjectInfo;
			$resultforLetterGradefop=$db->select_query($forLetterGradeop);
			if($resultforLetterGradefop){
				while($fetresultforLetterGrade=$resultforLetterGradefop->fetch_array()){
        ...
        <tr >
		<?php 
			$forGradepoint="  SELECT `marksheet`.*,`add_subject_info`.`select_subject_type` FROM `marksheet` 
 INNER JOIN `add_subject_info` ON `marksheet`.`SubjectId`=`add_subject_info`.`id` WHERE `STudentID`='$fetchFroStudent[STD_ID]' 
 AND `add_subject_info`.`select_subject_type`='CompulsorySubject' AND `marksheet`.`ExamId`='$examId' ORDER BY  `add_subject_info`.`serial` ASC";
		//print $forSubjectInfo;
			$resulforGradepoint=$db->select_query($forGradepoint);
			if($resulforGradepoint){
				while($fetresulforGradepoint=$resulforGradepoint->fetch_array()){
		
		?>
          <td width="55" height="25" align="center" style="border:1px #000000 solid;"><strong style="color:#000000; font-size:16px"><?php echo $fetresulforGradepoint["GradePoint"];?></strong></td>
		  <?php } }?>
		  
		  
		  <?php 
			$forGradepointgp="  SELECT `marksheet`.*,`add_subject_info`.`select_subject_type` FROM `marksheet` 
 INNER JOIN `add_subject_info` ON `marksheet`.`SubjectId`=`add_subject_info`.`id` WHERE `STudentID`='$fetchFroStudent[STD_ID]' 
 AND `add_subject_info`.`select_subject_type`='GroupSubject'  AND `marksheet`.`ExamId`='$examId' ORDER BY  `add_subject_info`.`serial` ASC";
		//print $forSubjectInfo;
			$resulforGradepointgp=$db->select_query($forGradepointgp);
			if($resulforGradepointgp){
				while($fetresulforGradepoint=$resulforGradepointgp->fetch_array()){
		...
		?>
		  ...
		  <?php } }?>
		    ...
		    <?php 
			$forGradepointop="  SELECT `marksheet`.*,`add_subject_info`.`select_subject_type` FROM `marksheet` 
 INNER JOIN `add_subject_info` ON `marksheet`.`SubjectId`=`add_subject_info`.`id` WHERE `STudentID`='$fetchFroStudent[STD_ID]' 
 AND `add_subject_info`.`select_subject_type`='OptionalSubject' AND `marksheet`.`ExamId`='$examId' ORDER BY  `add_subject_info`.`serial` ASC";
		//print $forSubjectInfo;
			$resulforGradepointop=$db->select_query($forGradepointop);
			if($resulforGradepointop){
				while($fetresulforGradepoint=$resulforGradepointop->fetch_array()){
