...
function ShowBack(){
 ...
 function calculate(getid) {
	...
	function AddMarksheet(){
			...
			var queryString= $('.marksInsertFrom').serialize();
			$.ajax({
				url : "InsertAddMarks.php",
				type: "POST",
				data : queryString,
				cache : false,
				success : function(data){
  ...
  <body>
  	<form name="teacherinfo" action="" method="post"  enctype="multipart/form-data" class="form-horizontal marksInsertFrom" >
            <div class="col-md-8 col-md-offset-2" id="AddMarksStep1"><br/> <br/>
                <span class="glyphicon glyphicon-arrow-right text-justify text-uppercase text-warning" style="font-weight: bold; padding-top: 15px; font-size: 18px;"><strong style="padding-left:5px">Add Mark </strong></span><br/>
                ...
                <tr><td colspan="2" align="center"><input type="button" name="submit" value="Submit" class="btn btn-danger btn-md" onClick="return AddMark()"  style="width: 90px"></input></td></tr>
                </table>
                </div>
