...
//view data...............................	
	if(isset($_POST['View']))
	{
        ...
        $table.="<tr class='warning' >"."<td align='left' colspan='5'>"."<a href='addsubject.php' class='btn btn-primary'>"."<span class='link text-center'>Back<span>"."</a>"."<span class='text-success' style='font-size:18px; padding-left:400px; font-weight:blod;'>View All Subject</span>"."</td>"."</tr>";
		if($result){
					...
					while ($v=$result_group->fetch_array())
					{
						...
						if($result_all)
						{
							...
							while($fetch_all=$result_all->fetch_array())
							{
								...
								$table.="<td>";
							$table.="<a href='?edit=$fetch_all[0]&cs=$v[0]&gp=$v[1]' class='btn btn-primary' style='width:80px' confirm_click='return confirm_click()'>Edit</a>";
							$table.="</td>";
								$table.="</tr>";
							}
						}
...
//end link edit data..........................
	...
	if(isset($_GET['dlt']))
	{
		...
		$query="DELETE FROM `add_subject_info` WHERE `id`='$id'";
		$delete=$db->delete_query($query);
		 $fetch[0]=$db->autogenerat('exam_type_info','exam_id','EXA-','9');
		 print "<script>location='addsubject.php'</script";
