					...
					<div class="col-md-10 col-md-offset-1">
							<table class="table table-responsive table-hover table-bordered "> 
									...
									<tr>
											...
											<td>
											<div class="col-md-8">
													<select id="Title" name="Title" class="form-control">														<optgroup label="Select Title">											<option>B.Sc.  Honours</option>
								...
								?>
									<tr>
										...
										<tr align="center">
											...
											<td width="17%"><a href="StaticviewTestimonial.php?date=<?php echo date('d/m/Y')?>&stdid=<?php echo $fetchforAll["boardResultID"];?>" class="btn btn-success btn-sm" target="_blank">Show</a>
							...
							<table class="table table-responsive table-hover table-bordered "> 
									...
									<tr>
										<td>Group /Subject</td>
											...
											<td>
											<div class="col-md-8">
													<select id="Group" name="Group" class="form-control">														<optgroup label="Select Group">								<option>Select One</option>
															<option>Science</option>
															<option>Business Studies</option>
															<option>Humanities</option>
		...
		//rint "dd";
			$bdid=$db->withoutPrefix('statictestomonialinfo','boardResultID','17','10');
					...
					&& !empty($_POST["MotherName"]) && isset($_POST["MotherName"])){
							 ...
							 $inssql="INSERT INTO `statictestomonialinfo` (`boardResultID`,`type`,`Title`,`GroupName`,`Session`,`year`,`RollNo`,`RegNo`,`GPA`,`studentName`,`fatherName`,`motherName`,gender) VALUES ('$bdid','".$_POST["type"]."','".$_POST["title"]."','".$_POST["group"]."','".$_POST["session"]."','".$_POST["Year"]."','".$_POST["RollNO"]."','".$_POST["regNo"]."','".$_POST["gpa"]."','".$_POST['studentName']."','".$_POST['fatherName']."','".$_POST['MotherName']."','".$_POST["gender"]."')";
