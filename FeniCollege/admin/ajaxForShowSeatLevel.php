...
$result_data = $db->select_query($sql1);		
  ...
  <tr style="border:1px #000000 solid" >
											...
											<span style="font-size:20px;"> <?php print $fetch_school_information['institute_name'] ?></span>
												 <br/>
												 <span style="font-size:16px; "> <?php print $fetch_school_information['location'] ?></span><br/>
												 <strong>
		<?php
