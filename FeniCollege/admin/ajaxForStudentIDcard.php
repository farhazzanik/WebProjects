					...
					?>
							...
							<tr style="border:1px #000000 solid" >
							  ...
							  &nbsp;</td>
									...
									<table width="433" border="1" cellpadding="0" cellspacing="0" style="margin-bottom:25px; width:460px;">
											...
											<?php }?>
											<tr>
											  <td style="padding-left:5px;  font-size:18px; border-right:1px #FFFFFF solid; border-bottom:1px #FFFFFF solid;">Roll No</td>
											  <td style="padding-left:5px;  font-size:18px; border-right:1px #FFFFFF solid; border-bottom:1px #FFFFFF solid;">:</td>
											...
											<td height="24" colspan="2"  align="left" style=" border-top:1px  #FFFFFF solid; border-right:1px #FFFFFF solid; font-size:16px; font-weight:600; letter-spacing:1;">&nbsp;</td>
											  <td height="24" colspan="3" align="right" style="border-top:1px  #FFFFFF solid; font-size:16px; font-weight:600; letter-spacing:1"><span>Head Master</span></td>
											</tr>
							  </table>
							</div>
							<?php  } 	} ?>
