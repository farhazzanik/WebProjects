...
<?php
	...
	$select_subject_name="SELECT * FROM `add_subject_part_info` WHERE `class_id`='$explode[0]' AND `group_id`='$explodegroup[0]' AND `subject_name`='".$_REQUEST["sub_name"]."' ORDER BY `subject_part_name`
ASC";
