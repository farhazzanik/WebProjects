					...
					$sl=0;
							...
							?>
								...
								<td width="16%">&nbsp;<?php if($fetchSql["status"]==="Active"){?>
									...
									<a href="#" class="btn btn-success btn-flat" style="width:120px;" onclick="return ADfun('<?php echo $fetchSql["id"]?>')">Ativated</a><?php } else {?>
							...
							<table class="table table-responsive table-hover table-bordered "> 
									...
									<tr>
										<td>Passward</td>
											...
											<td>
											<div class="col-md-8">
													<input type="text" class="form-control" name="Passward" id="Passward" placeholder="Passward.." />
											  </div>
											</td>
									</tr>
									<tr>
										<td>Re Passward</td>
											...
											<td>
											<div class="col-md-8">
													<input type="text" class="form-control" name="RePassward" id="RePassward" placeholder="Re Passward.." onkeyup="return passMatch()" />
											  </div><br/><br/>
