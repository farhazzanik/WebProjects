<?php
    ...
    $prefix=date("y"."m"."d");
    $fetch_all[0]=$db->withoutPrefix('donermembersinfo','id',"5".$prefix,'10');
    ...
    if(isset($_POST['add']))
    {
        if(!empty($_POST['teaherid'])&&!empty($_POST['teachername'])&&!empty($_POST['religious'])&&!empty($_POST['parmanentaddress'])&&!empty($_POST['positon']) && !empty($_POST["mobileno"]))
        {
            if(isset($_FILES['file'])){
               ...
               @$insert_query="INSERT INTO `donermembersinfo` (`id`,`index_no`,`name`,`designation`,`voter_id_no`,`date_of_birth`,`gender`,`blood_group`,`religion`,`matial_status`,`father_name`,`mother_name`,`present_address`,`parmanent_address`,`educational_qualification`,`mobile_no`) VALUES ('$fetch_all[0]','".$_POST["indexno"]."','".$_POST["teachername"]."','".$_POST["positon"]."','".$_POST["voterid"]."','".$_POST["brithdate"]."','".$_POST["gender"]."','".$_POST["bloodgroup"]."','".$_POST["religious"]."','".$_POST["meritialstatus"]."','".$_POST["fathername"]."','".$_POST["MOTHERNAME"]."','".$_POST["presentaddress"]."','".$_POST["parmanentaddress"]."','".$_POST["educationquality"]."','".$_POST["mobileno"]."')";
             ...
             $fetch_all[0]=$db->withoutPrefix('pta_information','id',"5".$prefix,'10');
    ...
    if(isset($_POST['srcbutton']))
    {
        ...
        if(!empty($srctext))
        {
                $src_query="SELECT * FROM `donermembersinfo`  WHERE `id`='$srctext'";
...
if(!empty($_POST['teaherid'])&&!empty($_POST['teachername'])&&!empty($_POST['religious'])&&!empty($_POST['parmanentaddress'])&&!empty($_POST['positon']) && !empty($_POST["mobileno"]))
        {
            if(isset($_FILES['file'])){
               ...
               @$insert_query="Replace INTO `donermembersinfo` (`id`,`index_no`,`name`,`designation`,`voter_id_no`,`date_of_birth`,`gender`,`blood_group`,`religion`,`matial_status`,`father_name`,`mother_name`,`present_address`,`parmanent_address`,`educational_qualification`,`mobile_no`) VALUES ('".$_POST["teaherid"]."','".$_POST["indexno"]."','".$_POST["teachername"]."','".$_POST["positon"]."','".$_POST["voterid"]."','".$_POST["brithdate"]."','".$_POST["gender"]."','".$_POST["bloodgroup"]."','".$_POST["religious"]."','".$_POST["meritialstatus"]."','".$_POST["fathername"]."','".$_POST["MOTHERNAME"]."','".$_POST["presentaddress"]."','".$_POST["parmanentaddress"]."','".$_POST["educationquality"]."','".$_POST["mobileno"]."')";
    ...
    if(isset($_POST['View']))
    {
        print "<script>location='viewDonerMembers.php'</script>";
    }
  
     //link edit
    if(isset($_GET['edit']))
    {
                 $src_query="SELECT * FROM `donermembersinfo`  WHERE `id`='".$_GET['edit']."'";
                $checked_query=$db->select_query($src_query);
                if($checked_query)
                {
                     $fetch_all=$checked_query->fetch_array();
    ...
    if(isset($_GET['dlt']))
    {
            $dlt_query="DELETE from `donermembersinfo` WHERE `id`='".$_GET['dlt']."'";
  	...
  	<form name="teacherinfo" action="" method="post"  enctype="multipart/form-data" class="form-horizontal" >
            ...
            <div class="form-group col-lg-10 col-sm-11  has-feedback">
                    <table class="table table-responsive col-sm-offset-1" align="center" border="0" cellpadding="0" cellspacing="0" style="margin-top: 20px;">
                            <tr>
                <td bgcolor="#f4f4f4" class="warning" colspan="4" bgcolor="#dddddd" align="center"><span style="font-size:22px; color:#333; display:block;">Members of donor information</span> </td>
            </tr>
                <tr class="success">
                ...
                <tr class="info">
                 ...
                 <tr class="success">
                    ...
                    <td>
                        <div class="col-lg-12 col-md-12 has-success ">
                            <input type="text" value="<?php echo $fetch_all[15]; ?>" name="mobileno" class="form-control" placeholder="Mobile No" />
                ...
                <tr class="info">
                    ...
                    <td colspan="2">
                        <div class="col-lg-12 col-md-8 col-sm-8 has-info ">
                            <textarea class="form-control" name="educationquality" placeholder="" id="redactor"><?php echo $fetch_all[14];?> </textarea>
                        </div>
                    </td>
