...
`gender`='".$_POST["gender"]."' WHERE `boardResultID`='".$_POST["id"]."'";
			...
			print "<script>location='StaticviewTestimonial.php?date=$_POST[dataTesto]&stdid=$_POST[id]'</script>";
		}
	?>
	<!DOCTYPE html>
<html lang="en">
									...
									<tr>
										...
										<tr>
											...
											<td colspan="3" align="center">
													<input type="submit" value="Update" name="update" class="btn btn-sm btn-success" formtarget="_blank" style="width:120px;" />
