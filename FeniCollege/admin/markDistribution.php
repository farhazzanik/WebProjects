  	...
  	<form name="teacherinfo" action="" method="post"  enctype="multipart/form-data" class="form-horizontal" >
                ...
                <table class="table table-responsive table-hover table-bordered">
                    <tr>
                     ...
                     <tr>
                        ...
                        <td colspan="6"><div class="col-md-6"><select class="form-control" id="subject_type" name="subject_type">
            ...
            <tr>
                <td bgcolor="#f4f4f4" class="warning" colspan="8"align="center" >
                    ...
                    <input type="button" onClick="return viewDetails()" value="View" name="View" class="btn btn-primary btn-sm" style="width:80px;"/>
