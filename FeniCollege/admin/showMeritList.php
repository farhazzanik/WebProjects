            ...
            <div class="col-md-10 col-md-offset-1"  style="border:2px #CCCCCC solid; margin-top:10px;"><br/> <br/>
                ...
                <table cellpadding="0" cellspacing="0"  class="table table-responsive table-hover " style="margin-top:0px;">					
							...
							<tr align="center">
								...
								<td style="border:1px #999999 solid;">Roll No.</td>
								<td style="border:1px #999999 solid;">Student's Name</td>
								<td style="border:1px #999999 solid;">Father's Name </td>
								<td style="border:1px #999999 solid;">Mother's Name </td>
...
INNER JOIN `student_personal_info` ON `student_personal_info`.`id`=`result`.`STD_ID`  WHERE `result`.`classId`='$clId'  AND `result`.`session`='$session' AND `result`.`GroupID`='$gpId' AND `result`.`examId`='$examId' AND `result`.`CGPA` !='0.00' ORDER BY `CGPA` DESC ";
							$result1=$db->select_query($sql1);
							...
							<tr align="center" class="">
								...
								<td style="border:1px #999999 solid;"><?php echo $fetchAll["student_name"]; ?></td>
								<td style="border:1px #999999 solid;"><?php echo $fetchAll["father_name"]; ?></td>
								<td style="border:1px #999999 solid;"><?php echo $fetchAll["mother_name"]; ?> </td>
