...
<table class="table table-responsive table-bordered table-hover" style="margin-top:10px;">
			<tr>
				<td ><input type="button" name="back" id="back" value="BACK" onclick="return bakpage()" class="btn btn-sm btn-danger" /></td><td align="center" colspan="10"><STRONG><span style="padding-left:0px; font-size:18px;" class="text-uppercase text-success text-muted"><?php echo $fetch_tiitle["institute_name"];?></span></STRONG></td>
			...
			<tr style="font-size:15px">
				<div class="col-md-6 col-lg-6">
					...
					<td colspan="3" align=""><strong class="text-success"><span style="padding-left:10px"><?php  echo $fetchAll["class_name"];?></span></strong></td>
				</div>	
				<div class="col-md-6 col-lg-6" >
			...
			<tr  style="font-size:15px">
				<div class="col-md-6 col-lg-6">
					...
					<td colspan="3"><strong class="text-success"><span style="padding-left:10px"><?php  echo $fetchAll["exam_type"];?></span></strong></td>
				</div>	
				<div class="col-md-6 col-lg-6">
			...
			<tr align="" style="font-size:15px">
				<div class="col-md-6 col-lg-6">
					...
					<td><span style="padding-left:10px"><strong class="text-success">:</strong></span></td>
					<td colspan="3"><strong class="text-success"><span style="padding-left:10px">
		 ...
		 <tr>
              <td colspan="11" align="center"><label for="from" class="text-warning">Roll No -</label>
...
<input type="text" name="to" id="to" value="<?php  echo $toss;?>"  style="width:120px; background:#F7071D; border:none; font-weight:bold; color:#fff; height:25px;  text-align:center;" onchange="return showChekTo()"  onkeyup="return showChekTo()"/>
	...
	<!--						<tr>
			...
			<tr>
			<tr>
				<td colspan="11" align="center"><input type="button" name="print" value="Print" onclick="return printpage()" class="btn btn-danger btn-sm" id="print" /></td>
			</tr>
