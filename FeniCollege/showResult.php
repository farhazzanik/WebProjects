				...
				<div class="container-fluid jumbotron" style="margin-top:0px;">
						...
						<div class="col-lg-7 col-sm-12 col-lg-offset-2 jumbotron" style="border:3px #FFFFFF solid; background:#FFFFFF" id="AddMarksStep1">
								...
								<table style="width:100%">
													<tr>
														<td><span class="text-justify" style="font-size:18px; color:#FFFFFF; border-bottom:2px  #FFFFFF solid; display:block"><strong>Ministry of Education</strong>
	</span></td>
													</tr>
													<tr>
											...
											<tr >
													<td align="right"><br/><span class="text-justify" ><strong><a href="./" style="font-size:13px; color:#FFFFFF; text-decoration:none" >Official Website of CFHS</a></strong>
	</span><br/></td>
											</tr>
											</table>
