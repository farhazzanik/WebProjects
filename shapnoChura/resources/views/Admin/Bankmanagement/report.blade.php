...
@include('error.msg')
 <div class="widget-box">
            ...
            <form class="form-horizontal" method="post" action="{{URL::to('shwoReportBank')}}" name="basic_validate" id="basic_validate" novalidate="novalidate">
             {{ csrf_field() }}
    ...
    $('#year').html('');
                    ...
                    if(type=='10'){
                        ...
                        if(type==='5'){
                            ...
                            $('#year').html('');
                            $('#group').html('');
                              $('#group').append('<label class="control-label">Date</label><div class="controls"><input type="text" name="data" data-date-format="mm-dd-yyyy" value="<?php echo date('m/d/Y')?>" placeholder="mm/dd/yyyy" class="datepicker span6"> </div>');
                        }
                        else if(type==='2'){
    $('#year').html('');
                            $('#group').html('');
