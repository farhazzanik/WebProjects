...
<table width="1217" border="1"  cellpadding="0" cellspacing="0" style="margin-top:-650px; float:left; margin-left:10px; position: relative;" >
          ...
          <tr style="padding-left: 10px; font-weight: bold;">
                        ...
                        <td width="60" style="padding-left: 10px;">{{$showDAta->date}}</td>
                           <td width="100" style="padding-left: 10px;">

                           

                              @if(count($bankname) > 0)
                              @foreach($bankname as $showname)
                              @if($showname->id === $showDAta->fk_bank_id)
                                    {{$showname->bank_name}}
                              @endif
                              @endforeach
                              @endif
                            ...
                            <td width="54" style="padding-left: 10px;">{{$showDAta->ammount}}</td>
                            <td width="54" style="padding-left: 10px;">{{$showDAta->naration}}</td>
                     </tr>   
                     @endforeach
