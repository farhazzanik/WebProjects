...
@include('error.msg')
 <div class="widget-box">
            ...
            <form class="form-horizontal" method="get" action="oop/DatetoDateInvestReport.php" name="basic_validate" id="basic_validate" novalidate="novalidate">
             {{ csrf_field() }}
  ...
  @else 
      ...
      @endif
         ...
         <div class="control-group">
              ...
              <div class="controls">
                <select  name ="invset"  id="name" class="span6" onchange="showpacks()">
                 <option>Select One</option>
        ...
        <div class="control-group">
              ...
              <div class="controls">
                <select  name ="packageType"  id="Type" class="span6" >
