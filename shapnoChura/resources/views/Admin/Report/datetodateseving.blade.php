...
@include('error.msg')
 <div class="widget-box">
            ...
            <form class="form-horizontal" method="get" action="oop/DatetoDateSavingReport.php" name="basic_validate" id="basic_validate" novalidate="novalidate">
             {{ csrf_field() }}
  ...
  @else 
      ...
      @endif
         ...
         <div class="control-group">
              ...
              <div class="controls">
                <select  name ="saving"  id="name" class="span6" onchange="showpacks()">
                 <option>Select One</option>
        ...
        <div class="control-group">
              ...
              <div class="controls">
                <select  name ="pakacgeType"  id="Type" class="span6" >
