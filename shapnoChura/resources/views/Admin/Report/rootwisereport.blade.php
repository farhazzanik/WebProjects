...
@include('error.msg')
 <div class="widget-box">
            ...
            <form class="form-horizontal" method="post" action="{{URL::to('rootcollection')}}" name="basic_validate" id="basic_validate" novalidate="novalidate">
             {{ csrf_field() }}
  ...
  @else 
      ...
      @endif
             ...
             <div class="control-group">
              ...
              <div class="controls">
                <select  name ="package"  id="package" class="span6" onchange="show()">
                 <option value="10">Select A one</option>
              ...
              <div class="control-group" id="pack">
                   ...
                   function show(){    
                    ...
                    if(package=='10'){
                        ...
                        if(package==='1'){
                            ...
                            $('#pack').html('');
                              $('#pack').append('<label class="control-label">package</label><div class="controls"><select name="savingpackage" class="span6">@foreach($pack as $p)<option value="{{$p->id}}">{{$p->name}}</option>@endforeach</select> </div>');
                        }
                        else if(package==='2'){

                            $('#pack').html('');
                              $('#pack').append('<label class="control-label">package</label><div class="controls"><select name="investpackage" class="span6"><option value="5">Daily</option><option value="1">Weekly</option><option value="2">Monthly</option><option value="3">Yearly</option><option value="4">General</option></select> </div>');
                        }
