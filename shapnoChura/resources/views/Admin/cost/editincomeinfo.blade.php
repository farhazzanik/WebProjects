...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js"></script>
 ...
 <div class="widget-box">
    ...
    <div class="widget-box">
            ...
            <h5>Edit Debit Information</h5>
          </div>
                     <div class="widget-content nopadding">
            <form class="form-horizontal" method="post" action="{{URL::to('updateSuccincome')}}" name="basic_validate" id="basic_validate" novalidate="novalidate">
             {{ csrf_field() }}
 ...
 @if($id->fk_brance_id == '1')
          ...
          <div class="control-group">
              ...
              <div class="controls">
                ...
                <select  name ="Brance"  id="Brance" class="span6"  onchange="ShowMem()">
  ...
  @else 
   ...
   <div class="control-group">
              ...
              <div class="controls">
                ...
                <option value="{{$data[0]->fk_mem_id}}">{{$data[0]->mem_name}}</option>
