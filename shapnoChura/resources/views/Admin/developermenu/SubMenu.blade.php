 ...
 <div class="widget-box">
    ...
    <div class="widget-box">
            ...
            <form class="form-horizontal" method="post" action="{{URL::to('AdminSubLinkSave')}}" name="basic_validate" id="basic_validate" novalidate="novalidate">
             {{ csrf_field() }}
              ...
              <div class="control-group" id="staticParent">
                ...
                <div class="controls">
                  <input type="text"  placeholder="Serial No"  class="span6"  
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <select  name ="mainMenuName"  id="countryId" class="span6">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" placeholder="Sub Menu Name English"
                   name="SubMenuEn" id="SubMenuEn" class="span6" value="{{old('SubMenuEn')}}">
                </div>
              </div>
