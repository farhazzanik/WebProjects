<? $actadmin=DB::table('createadmin')->first(); ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<!--Header-part-->
<div id="header">
  <h1><a href="dashboard.html">ShapnaChura Admin</a></h1>
</div>
<!--close-Header-part--> 
...
<!--     <li class="dropdown" id="menu-messages"><a href="#" data-toggle="dropdown" data-target="#menu-messages" class="dropdown-toggle"><i class="icon icon-envelope"></i> <span class="text">Messages</span> <span class="label label-important">5</span> <b class="caret"></b></a>
   ...
   <!--  <li class=""><a title="" href="#"><i class="icon icon-cog"></i> <span class="text">Settings</span></a></li> -->
    ...
    <li class=""><a title="" href="#"><i class="icon icon-user"></i> <span class="text">{{Auth::guard('admin')->user()->name}}</span></a></li>
  </ul>
</div>
...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    <li class=""><a href="{{url('/Dashboard')}}"><i class="icon icon-home"></i> <span>Dashboard</span></a> </li>
   ...
   <li class="submenu"> <a href="#"><i class="icon icon-th-list"></i> <span>Developer Forms</span> <span class="label label-important">3</span></a>
      <ul>
        ...
        <li><a href="{{URL::to('SubMenu')}}">Sub Menu Link</a></li>
         <li><a href="{{URL::to('Brance')}}">Brance Information</a></li>
...
@if($showMainlink->routeName == '0')
 <li class="submenu"> <a href="#"><i class="icon icon-th-list"></i> <span>{{$showMainlink->Link_Name}}</span> <span class="label label-important">2</span></a>
      <ul>
