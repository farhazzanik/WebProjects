...
@include('error.msg')
 <div class="widget-box">
            ...
            <h5>Invest collection Report</h5>
          </div>
              			 <div class="widget-content nopadding">
            <form class="form-horizontal" method="post" action="{{URL::to('showInvestReport')}}" name="basic_validate" id="basic_validate" novalidate="novalidate">
             {{ csrf_field() }}
  ...
  @else 
      ...
      @endif
         ...
         <div class="control-group">
              ...
              <div class="controls">
                <select  name ="Type"  id="Type" class="span6" onchange="return ShowMem(),msd()">
      ...
      function  ShowMem(){
        ...
        var branceid = $('#Brance').val();
         ...
         // alert(data);
                  ...
                  batchOption.append('<option value="'+value.fk_app_id+'and'+value.fk_invest_id+'">'+value.mem_name+'('+value.fk_invest_id+')'+'</option>');
