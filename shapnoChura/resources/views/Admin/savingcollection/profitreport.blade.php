...
@include('error.msg')
 <div class="widget-box">
            ...
            <form class="form-horizontal" method="post" action="{{URL::to('showprofitrept')}}" name="basic_validate" id="basic_validate" novalidate="novalidate">
             {{ csrf_field() }}
      ...
      function  ShowMem(){
        ...
        var branceid = $('#Brance').val();
         ...
         // alert(data);
                  ...
                  batchOption.append('<option value="'+value.mem_id+'/'+value.mem_add_id+'">'+value.mem_name+'</option>');
                  });
                   $("#districloader").html("");
                 },
                 error:function(data){
